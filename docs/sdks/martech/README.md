...
$request = new Operations\CreateMartechCampaignRequest(
    marketingCampaign: new Shared\MarketingCampaign(
        ...
        id: 'a55fe58f-5cb8-45c3-9aff-bed65534d290',
        listIds: [
...
$request = new Operations\CreateMartechListRequest(
    marketingList: new Shared\MarketingList(
        ...
        description: 'Currus.',
        id: 'eac03c0b-f95e-4c08-8a25-a7b0b10435ab',
        isActive: true,
        language: 'it',
        name: 'Annette Nolan',
        ...
        updatedAt: Utils\Utils::parseDateTime('2022-08-31T08:28:48.553Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateMartechMemberRequest(
    marketingMember: new Shared\MarketingMember(
        ...
        firstName: 'Jude',
        id: '09320d38-5960-476e-b967-7839d616b7bf',
        lastName: 'Leffler',
        name: 'Jude Leffler',
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-06-16T15:14:25.555Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchMartechCampaignRequest(
    marketingCampaign: new Shared\MarketingCampaign(
        ...
        fromEmail: 'Nick.Beahan@hotmail.com',
        fromName: 'Javier Rempel',
        id: '4a8f1d57-6778-4446-a53f-7992871ab008',
        listIds: [
            'bde5cab9-cf2f-4ed5-adab-b33c88bac5af',
        ],
        name: 'Consequatur atqui sustineo.',
...
$request = new Operations\PatchMartechListRequest(
    marketingList: new Shared\MarketingList(
        ...
        createdAt: Utils\Utils::parseDateTime('2019-09-18T02:01:36.950Z'),
        description: 'Currus.',
        id: 'c1a7726f-b403-479b-8c09-3a3739b7afeb',
        isActive: true,
        language: 'it',
        name: 'Annette Nolan',
        senderCompany: 'Hickle - Homenick',
        ...
        senderPhone: '896-328-1153 x4957',
        subject: 'Tenetur thymum circumvenio triumphus celo.',
        updatedAt: Utils\Utils::parseDateTime('2022-08-31T08:28:48.563Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchMartechMemberRequest(
    marketingMember: new Shared\MarketingMember(
        ...
        firstName: 'Jude',
        id: 'e8353afd-9879-43e4-bf10-f4312aa4d48c',
        lastName: 'Leffler',
        name: 'Jude Leffler',
        status: Shared\MarketingMemberStatus::Unsubscribed,
        tags: [
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-06-16T15:14:25.565Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
