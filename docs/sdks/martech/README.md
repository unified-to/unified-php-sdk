...
$request = new Operations\CreateMartechListRequest(
    marketingList: new Shared\MarketingList(
        ...
        description: 'Currus.',
        id: 'eb182e00-fe6d-4d5f-84bc-6215e58f64b3',
        isActive: true,
        language: 'it',
        name: 'Annette Nolan',
        ...
        updatedAt: Utils\Utils::parseDateTime('2022-08-30T22:50:03.557Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateMartechMemberRequest(
    marketingMember: new Shared\MarketingMember(
        ...
        firstName: 'Jude',
        id: '2353367f-52e3-437d-b9b1-9ab503889033',
        lastName: 'Leffler',
        name: 'Jude Leffler',
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-06-15T22:51:39.124Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchMartechListRequest(
    marketingList: new Shared\MarketingList(
        ...
        createdAt: Utils\Utils::parseDateTime('2019-09-18T02:01:36.950Z'),
        description: 'Currus.',
        id: 'c49bf68a-770b-41cb-a3b7-e7c60860c806',
        isActive: true,
        language: 'it',
        name: 'Annette Nolan',
        senderCompany: 'Hickle - Homenick',
        ...
        senderPhone: '896-328-1153 x4957',
        subject: 'Tenetur thymum circumvenio triumphus celo.',
        updatedAt: Utils\Utils::parseDateTime('2022-08-30T22:50:03.562Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchMartechMemberRequest(
    marketingMember: new Shared\MarketingMember(
        ...
        firstName: 'Jude',
        id: '161ee49e-876e-4781-8611-10d90c8da6dd',
        lastName: 'Leffler',
        name: 'Jude Leffler',
        status: Shared\MarketingMemberStatus::Unsubscribed,
        tags: [
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-06-15T22:51:39.129Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
