...
try {
    ...
    $request->connectionId = 'virtual BMX Tuna';
    $request->dealId = 'frightened quia generating';
    $request->id = '<ID>';
...
try {
    ...
    $request->connectionId = 'Hybrid Mississippi Savings';
    $request->dealId = 'West Hill Woman';
    $request->id = '<ID>';
