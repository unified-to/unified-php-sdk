...
$request = new Operations\CreateTicketingCategoryRequest(
    ticketingCategory: new Shared\TicketingCategory(
        ...
        isActive: true,
        name: 'amicitia',
        updatedAt: Utils\Utils::parseDateTime('2025-12-17T09:39:40.825Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateTicketingCustomerRequest(
    ticketingCustomer: new Shared\TicketingCustomer(
        ...
        updatedAt: Utils\Utils::parseDateTime('2026-05-06T04:06:55.504Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateTicketingNoteRequest(
    ticketingNote: new Shared\TicketingNote(
        ...
        updatedAt: Utils\Utils::parseDateTime('2024-09-07T01:47:29.020Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchTicketingCategoryRequest(
    ticketingCategory: new Shared\TicketingCategory(
        ...
        isActive: true,
        name: 'amicitia',
        updatedAt: Utils\Utils::parseDateTime('2025-12-17T09:39:40.832Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchTicketingCustomerRequest(
    ticketingCustomer: new Shared\TicketingCustomer(
        ...
        updatedAt: Utils\Utils::parseDateTime('2026-05-06T04:06:55.518Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchTicketingNoteRequest(
    ticketingNote: new Shared\TicketingNote(
        ...
        updatedAt: Utils\Utils::parseDateTime('2024-09-07T01:47:29.025Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
