...
$request = new Operations\CreateTicketingCategoryRequest(
    ticketingCategory: new Shared\TicketingCategory(
        ...
        isActive: true,
        name: 'amicitia',
        updatedAt: Utils\Utils::parseDateTime('2025-12-18T02:58:36.950Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateTicketingCustomerRequest(
    ticketingCustomer: new Shared\TicketingCustomer(
        ...
        updatedAt: Utils\Utils::parseDateTime('2026-05-06T22:14:18.891Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateTicketingNoteRequest(
    ticketingNote: new Shared\TicketingNote(
        ...
        updatedAt: Utils\Utils::parseDateTime('2024-09-07T15:42:43.004Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchTicketingCategoryRequest(
    ticketingCategory: new Shared\TicketingCategory(
        ...
        isActive: true,
        name: 'amicitia',
        updatedAt: Utils\Utils::parseDateTime('2025-12-18T02:58:36.954Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchTicketingCustomerRequest(
    ticketingCustomer: new Shared\TicketingCustomer(
        ...
        updatedAt: Utils\Utils::parseDateTime('2026-05-06T22:14:18.897Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchTicketingNoteRequest(
    ticketingNote: new Shared\TicketingNote(
        ...
        updatedAt: Utils\Utils::parseDateTime('2024-09-07T15:42:43.007Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
