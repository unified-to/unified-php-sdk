...
$request = new Operations\CreateAccountingBillRequest(
    accountingBill: new Shared\AccountingBill(
        ...
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2025-01-31T04:40:21.326Z'),
...
$request = new Operations\CreateAccountingCategoryRequest(
    accountingCategory: new Shared\AccountingCategory(
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-08-22T03:49:23.607Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAccountingCreditmemoRequest(
    accountingCreditmemo: new Shared\AccountingCreditmemo(
        ...
        postedAt: Utils\Utils::parseDateTime('2025-11-17T11:22:22.052Z'),
        refundAmount: 0,
        ...
        taxAmount: 0,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2024-11-16T15:28:24.980Z'),
    ...
    accountingInvoice: new Shared\AccountingInvoice(
        attachments: [
            new Shared\AccountingAttachment(
                ...
                id: 'a086fefd-c55c-4086-8542-9968b04e5561',
        ...
        extendedNotes: [],
        id: 'a3e2a8ae-f055-408c-a0f6-ab0bb70b14f7',
        invoiceNumber: 'vinco',
        ...
        payments: [],
        postedAt: Utils\Utils::parseDateTime('2026-03-29T09:35:22.722Z'),
        ...
        updatedAt: Utils\Utils::parseDateTime('2023-02-06T11:07:47.339Z'),
...
$request = new Operations\CreateAccountingJournalRequest(
    accountingJournal: new Shared\AccountingJournal(
        ...
        id: 'fa50e556-5eab-4cb7-afd1-a16ff072dcc4',
        isInclusiveOfTax: true,
        postedAt: Utils\Utils::parseDateTime('2023-10-20T15:13:49.802Z'),
        reference: 'ullam',
        source: 'crustulum',
        status: Shared\AccountingJournalStatus::Void,
        taxAmount: 78672,
        totalAmount: 74094,
        updatedAt: Utils\Utils::parseDateTime('2022-01-02T06:10:58.511Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAccountingPaymenttermRequest(
    accountingPaymentterm: new Shared\AccountingPaymentterm(
        ...
        dueDays: 57,
        dueNextMonthDays: 9,
        id: '6c9516f3-8973-4fc0-b9eb-6b8b42fe52f0',
        isActive: false,
        metadata: [],
        name: 'Net 30',
        type: Shared\AccountingPaymenttermType::Net15,
        updatedAt: Utils\Utils::parseDateTime('2025-12-13T20:05:08.549Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAccountingPurchaseorderRequest(
    accountingPurchaseorder: new Shared\AccountingPurchaseorder(
        ...
        lineitems: [],
        metadata: [],
        postedAt: Utils\Utils::parseDateTime('2025-04-27T06:22:37.375Z'),
        ...
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2021-02-26T05:43:51.981Z'),
    ),
    connectionId: '<id>',
);
...
$response = $sdk->accounting->createAccountingVendorcredit(
    request: $request
);
...
$response = $sdk->accounting->getAccountingVendorcredit(
    request: $request
);
...
$response = $sdk->accounting->listAccountingVendorcredits(
    request: $request
);
...
$request = new Operations\PatchAccountingAccountRequest(
    accountingAccount: new Shared\AccountingAccount(
        ...
        customerDefinedCode: 'quo',
        description: 'Spoliatio comedo vilitas harum cupiditate.',
        id: 'd91a9733-3a17-4074-a1b1-aa422f50d958',
        isPayable: true,
        name: 'Electronic Aluminum Tuna',
        status: Shared\Status::Archived,
        taxonomy: [
        ...
        type: Shared\Type::Bank,
        updatedAt: Utils\Utils::parseDateTime('2023-01-03T11:11:55.469Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAccountingBankfeedaccountRequest(
    accountingBankfeedaccount: new Shared\AccountingBankfeedaccount(
        ...
        currency: 'SSP',
        feedStartAt: Utils\Utils::parseDateTime('2022-10-31T16:42:19.277Z'),
        id: 'd019420d-033e-4e21-8a76-2104d7cbef79',
        name: 'Corwin, Donnelly and Connelly Savings',
        routingNumber: '667753156',
        status: Shared\AccountingBankfeedaccountStatus::Active,
        updatedAt: Utils\Utils::parseDateTime('2024-04-12T13:57:09.411Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAccountingBillRequest(
    accountingBill: new Shared\AccountingBill(
        ...
        dueAt: Utils\Utils::parseDateTime('2019-08-11T20:52:55.321Z'),
        extendedNotes: [],
        id: 'f9268e84-980f-40e0-a64b-2c964ec54a34',
        lineitems: [],
        metadata: [],
        notes: 'Tutamen cilicium infit.',
        paymentCollectionMethod: Shared\PaymentCollectionMethod::ChargeAutomatically,
        payments: [],
        postedAt: Utils\Utils::parseDateTime('2024-04-06T03:20:50.910Z'),
        purchaseorderIds: [],
        send: true,
        status: Shared\AccountingBillStatus::Deleted,
        subTotalAmount: 0,
        ...
        term: Shared\Term::Net10,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2025-01-31T04:40:21.369Z'),
        url: 'https://coarse-interviewer.biz/',
    ),
    connectionId: '<id>',
    id: '<id>',
...
$request = new Operations\PatchAccountingCategoryRequest(
    accountingCategory: new Shared\AccountingCategory(
        ...
        metadata: [],
        name: 'Electronic Cotton Shoes',
        updatedAt: Utils\Utils::parseDateTime('2025-08-22T03:49:23.618Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAccountingCreditmemoRequest(
    accountingCreditmemo: new Shared\AccountingCreditmemo(
        ...
        notes: 'Dedecor amo adfero torqueo quas.',
        paymentCollectionMethod: Shared\AccountingCreditmemoPaymentCollectionMethod::ChargeAutomatically,
        postedAt: Utils\Utils::parseDateTime('2025-11-17T11:22:22.083Z'),
        refundAmount: 0,
        refundReason: 'Virgo inflammatio quibusdam aestivus magnam.',
        refundedAt: Utils\Utils::parseDateTime('2023-10-23T00:35:36.814Z'),
        send: false,
        ...
        taxAmount: 0,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2024-11-16T15:28:24.996Z'),
        url: 'https://lighthearted-bandwidth.net/',
    ),
    connectionId: '<id>',
    id: '<id>',
...
$request = new Operations\PatchAccountingInvoiceRequest(
    accountingInvoice: new Shared\AccountingInvoice(
        attachments: [
            new Shared\AccountingAttachment(
                downloadUrl: 'https://glossy-markup.net/',
                id: '42f96d4c-bad4-4392-8233-a33df24a8c6c',
                mimeType: 'benevolentia',
                name: 'vespillo',
            ),
        ],
        ...
        dueAt: Utils\Utils::parseDateTime('2022-11-27T21:25:37.363Z'),
        extendedNotes: [],
        id: '06ca1e6c-52aa-4fe5-8ec5-54e9da3aa325',
        invoiceNumber: 'vinco',
        isInclusiveOfTax: true,
        lineitems: [],
        metadata: [],
        ...
        paymentCollectionMethod: Shared\AccountingInvoicePaymentCollectionMethod::SendInvoice,
        payments: [],
        postedAt: Utils\Utils::parseDateTime('2026-03-29T09:35:22.780Z'),
        reference: 'adinventitias',
        salesorderIds: [],
        send: true,
        status: Shared\AccountingInvoiceStatus::Deleted,
        ...
        totalAmount: 0,
        type: Shared\AccountingInvoiceType::Creditmemo,
        updatedAt: Utils\Utils::parseDateTime('2023-02-06T11:07:47.343Z'),
        url: 'https://gifted-yarmulke.info/',
    ),
    connectionId: '<id>',
    id: '<id>',
...
$request = new Operations\PatchAccountingJournalRequest(
    accountingJournal: new Shared\AccountingJournal(
        ...
        currency: 'FKP',
        description: 'Calco constans adipisci.',
        id: 'f7779d43-9388-4634-8682-5de7127545a9',
        isInclusiveOfTax: true,
        postedAt: Utils\Utils::parseDateTime('2023-10-20T15:13:49.817Z'),
        reference: 'ullam',
        source: 'crustulum',
        status: Shared\AccountingJournalStatus::Void,
        taxAmount: 78672,
        totalAmount: 74094,
        updatedAt: Utils\Utils::parseDateTime('2022-01-02T06:10:58.518Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAccountingPaymenttermRequest(
    accountingPaymentterm: new Shared\AccountingPaymentterm(
        ...
        dueDays: 57,
        dueNextMonthDays: 9,
        id: '708643f5-baec-4dfc-8c39-cc2303907aa2',
        isActive: false,
        metadata: [],
        name: 'Net 30',
        type: Shared\AccountingPaymenttermType::Net15,
        updatedAt: Utils\Utils::parseDateTime('2025-12-13T20:05:08.559Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAccountingPurchaseorderRequest(
    accountingPurchaseorder: new Shared\AccountingPurchaseorder(
        ...
        lineitems: [],
        metadata: [],
        postedAt: Utils\Utils::parseDateTime('2025-04-27T06:22:37.417Z'),
        shippingAddress: new Shared\PropertyAccountingPurchaseorderShippingAddress(
            address1: '649 Maggio Overpass',
            city: 'Lake Jaylan',
            countryCode: 'US',
        ...
        status: Shared\AccountingPurchaseorderStatus::PartiallyRefunded,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2021-02-26T05:43:51.983Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$response = $sdk->accounting->patchAccountingVendorcredit(
    request: $request
);
...
$response = $sdk->accounting->removeAccountingVendorcredit(
    request: $request
);
...
$response = $sdk->accounting->updateAccountingVendorcredit(
    request: $request
);
