...
$request = new Operations\CreateAccountingBankfeedtransactionRequest(
    accountingBankfeedtransaction: new Shared\AccountingBankfeedtransaction(
        ...
        postedAt: Utils\Utils::parseDateTime('2025-03-25T02:27:02.515Z'),
        reference: '93642593',
        transactionAt: Utils\Utils::parseDateTime('2022-07-27T23:26:18.357Z'),
        type: Shared\AccountingBankfeedtransactionType::Credit,
        updatedAt: Utils\Utils::parseDateTime('2022-05-23T22:31:57.228Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingBankfeedtransactionRequest(
    accountingBankfeedtransaction: new Shared\AccountingBankfeedtransaction(
        ...
        isPending: true,
        merchantName: 'Reichert, Erdman and Tillman',
        postedAt: Utils\Utils::parseDateTime('2025-03-25T02:27:02.521Z'),
        reference: '93642593',
        transactionAt: Utils\Utils::parseDateTime('2022-07-27T23:26:18.358Z'),
        type: Shared\AccountingBankfeedtransactionType::Credit,
        updatedAt: Utils\Utils::parseDateTime('2022-05-23T22:31:57.228Z'),
    ),
    connectionId: '<id>',
