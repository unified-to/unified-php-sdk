...
$request = new Operations\CreateAccountingBankfeedtransactionRequest(
    accountingBankfeedtransaction: new Shared\AccountingBankfeedtransaction(
        ...
        postedAt: Utils\Utils::parseDateTime('2025-03-24T11:09:03.597Z'),
        reference: '93642593',
        transactionAt: Utils\Utils::parseDateTime('2022-07-27T21:41:37.724Z'),
        type: Shared\AccountingBankfeedtransactionType::Credit,
        updatedAt: Utils\Utils::parseDateTime('2022-05-23T21:41:44.690Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingBankfeedtransactionRequest(
    accountingBankfeedtransaction: new Shared\AccountingBankfeedtransaction(
        ...
        isPending: true,
        merchantName: 'Reichert, Erdman and Tillman',
        postedAt: Utils\Utils::parseDateTime('2025-03-24T11:09:03.604Z'),
        reference: '93642593',
        transactionAt: Utils\Utils::parseDateTime('2022-07-27T21:41:37.725Z'),
        type: Shared\AccountingBankfeedtransactionType::Credit,
        updatedAt: Utils\Utils::parseDateTime('2022-05-23T21:41:44.690Z'),
    ),
    connectionId: '<id>',
