...
try {
    ...
    $response = $sdk->organization->getAccountingOrganization($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->organization->listAccountingOrganizations($request, $requestSecurity);
