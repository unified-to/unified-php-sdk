...
$request = new Operations\CreateAnalyticsEventRequest(
    analyticsEvent: new Shared\AnalyticsEvent(
        ...
        name: 'Xk707ttsb51v',
        updatedAt: Utils\Utils::parseDateTime('2023-09-22T05:59:00.637Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateCrmEventRequest(
    crmEvent: new Shared\CrmEvent(
        call: new Shared\PropertyCrmEventCall(
            ...
            duration: 64,
            startAt: Utils\Utils::parseDateTime('2024-11-19T05:09:01.052Z'),
        ),
        ...
        updatedAt: Utils\Utils::parseDateTime('2026-09-10T15:37:41.064Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchCrmEventRequest(
    crmEvent: new Shared\CrmEvent(
        call: new Shared\PropertyCrmEventCall(
            description: 'Arbitro aptus.',
            duration: 64,
            startAt: Utils\Utils::parseDateTime('2024-11-19T05:09:01.089Z'),
        ),
        createdAt: Utils\Utils::parseDateTime('2020-07-14T04:53:23.784Z'),
        id: '9fd48e84-ce19-4830-a40a-0079f0159f3b',
        type: Shared\CrmEventType::Call,
        updatedAt: Utils\Utils::parseDateTime('2026-09-10T15:37:41.116Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
