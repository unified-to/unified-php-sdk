...
$request = new Operations\CreateAccountingOrderRequest(
    accountingOrder: new Shared\AccountingOrder(
        ...
        currency: 'USD',
        id: 'cb17a1cc-fb34-4ca4-a3be-805c7afba555',
        lineitems: [],
        metadata: [],
        postedAt: Utils\Utils::parseDateTime('2022-04-05T06:04:47.880Z'),
        ...
        updatedAt: Utils\Utils::parseDateTime('2021-06-18T01:07:22.644Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAssessmentOrderRequest(
    assessmentOrder: new Shared\AssessmentOrder(
        ...
        updatedAt: Utils\Utils::parseDateTime('2023-01-17T08:28:09.226Z'),
        workspaceId: '<id>',
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingOrderRequest(
    accountingOrder: new Shared\AccountingOrder(
        ...
        createdAt: Utils\Utils::parseDateTime('2020-11-20T03:46:49.837Z'),
        currency: 'USD',
        id: '2db28292-3954-462c-8a09-3109157d88b2',
        lineitems: [],
        metadata: [],
        postedAt: Utils\Utils::parseDateTime('2022-04-05T06:04:47.892Z'),
        shippingAddress: new Shared\PropertyAccountingOrderShippingAddress(
            address1: '9745 Betty Shore',
            city: 'South Alainaland',
            countryCode: 'US',
        ...
        totalAmount: 0,
        type: Shared\AccountingOrderType::Purchase,
        updatedAt: Utils\Utils::parseDateTime('2021-06-18T01:07:22.649Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAssessmentOrderRequest(
    assessmentOrder: new Shared\AssessmentOrder(
        ...
        status: Shared\AssessmentOrderStatus::Rejected,
        targetUrl: 'https://cautious-turret.info',
        updatedAt: Utils\Utils::parseDateTime('2023-01-17T08:28:09.237Z'),
        workspaceId: '<id>',
    ),
    connectionId: '<id>',
    id: '<id>',
