...
$request = new Operations\CreateAccountingVendorcreditRequest(
    accountingVendorcredit: new Shared\AccountingVendorcredit(
        ...
        id: 'f0c48d30-40af-49e9-adee-74ec6e730e51',
        lineitems: [],
        metadata: [],
        notes: 'Conatus cruciamentum decor avaritia tantum.',
        postedAt: Utils\Utils::parseDateTime('2023-09-28T20:00:55.743Z'),
        status: Shared\AccountingVendorcreditStatus::Submitted,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2023-11-26T19:03:05.481Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingVendorcreditRequest(
    accountingVendorcredit: new Shared\AccountingVendorcredit(
        ...
        currency: 'KGS',
        dueAt: Utils\Utils::parseDateTime('2023-05-06T20:38:46.775Z'),
        id: '12145c50-8741-4b3c-8971-e44ea48faf61',
        lineitems: [],
        metadata: [],
        notes: 'Conatus cruciamentum decor avaritia tantum.',
        postedAt: Utils\Utils::parseDateTime('2023-09-28T20:00:55.748Z'),
        status: Shared\AccountingVendorcreditStatus::Submitted,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2023-11-26T19:03:05.488Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
