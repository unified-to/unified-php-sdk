...
$request = new Operations\CreateAccountingCategoryRequest(
    accountingCategory: new Shared\AccountingCategory(
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-08-20T23:18:13.582Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateTicketingCategoryRequest(
    ticketingCategory: new Shared\TicketingCategory(
        ...
        isActive: true,
        name: 'amicitia',
        updatedAt: Utils\Utils::parseDateTime('2025-12-16T13:16:32.285Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingCategoryRequest(
    accountingCategory: new Shared\AccountingCategory(
        ...
        metadata: [],
        name: 'Electronic Cotton Shoes',
        updatedAt: Utils\Utils::parseDateTime('2025-08-20T23:18:13.592Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchTicketingCategoryRequest(
    ticketingCategory: new Shared\TicketingCategory(
        ...
        isActive: true,
        name: 'amicitia',
        updatedAt: Utils\Utils::parseDateTime('2025-12-16T13:16:32.288Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
