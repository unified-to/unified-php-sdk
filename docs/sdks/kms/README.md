...
$request = new Operations\CreateKmsCommentRequest(
    kmsComment: new Shared\KmsComment(
        ...
        updatedAt: Utils\Utils::parseDateTime('2023-11-17T04:28:29.168Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateKmsPageRequest(
    kmsPage: new Shared\KmsPage(
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-09-13T04:14:05.570Z'),
...
$request = new Operations\CreateKmsSpaceRequest(
    kmsSpace: new Shared\KmsSpace(
        ...
        isActive: false,
        name: 'into nor afore',
        updatedAt: Utils\Utils::parseDateTime('2025-12-05T21:21:09.630Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchKmsCommentRequest(
    kmsComment: new Shared\KmsComment(
        ...
        type: Shared\KmsCommentType::Page,
        updatedAt: Utils\Utils::parseDateTime('2023-11-17T04:28:29.172Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchKmsPageRequest(
    kmsPage: new Shared\KmsPage(
        ...
        title: 'even minister extract',
        type: Shared\KmsPageType::Html,
        updatedAt: Utils\Utils::parseDateTime('2025-09-13T04:14:05.587Z'),
        webUrl: 'https://another-petticoat.info',
    ),
    connectionId: '<id>',
    id: '<id>',
...
$request = new Operations\PatchKmsSpaceRequest(
    kmsSpace: new Shared\KmsSpace(
        ...
        isActive: false,
        name: 'into nor afore',
        updatedAt: Utils\Utils::parseDateTime('2025-12-05T21:21:09.637Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
