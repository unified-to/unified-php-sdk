...
$request = new Operations\CreateKmsPageRequest(
    kmsPage: new Shared\KmsPage(
        ...
        hasChildren: true,
        id: 'a125270e-1d39-4b05-9c47-04c422a96d17',
        isActive: true,
        metadata: [],
        title: 'even minister extract',
        type: Shared\KmsPageType::Html,
        updatedAt: Utils\Utils::parseDateTime('2025-09-12T11:29:40.149Z'),
...
$request = new Operations\CreateKmsSpaceRequest(
    kmsSpace: new Shared\KmsSpace(
        ...
        isActive: false,
        name: 'into nor afore',
        updatedAt: Utils\Utils::parseDateTime('2025-12-05T05:51:45.596Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchKmsPageRequest(
    kmsPage: new Shared\KmsPage(
        ...
        downloadUrl: 'https://agitated-validity.info',
        hasChildren: true,
        id: 'b94a5481-73c6-481c-82f1-3d7dcb516646',
        isActive: true,
        metadata: [],
        title: 'even minister extract',
        type: Shared\KmsPageType::Html,
        updatedAt: Utils\Utils::parseDateTime('2025-09-12T11:29:40.167Z'),
        webUrl: 'https://another-petticoat.info',
    ),
    connectionId: '<id>',
    id: '<id>',
...
$request = new Operations\PatchKmsSpaceRequest(
    kmsSpace: new Shared\KmsSpace(
        ...
        isActive: false,
        name: 'into nor afore',
        updatedAt: Utils\Utils::parseDateTime('2025-12-05T05:51:45.604Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
