...
$request = new Operations\CreateAccountingTaxrateRequest(
    accountingTaxrate: new Shared\AccountingTaxrate(
        ...
        id: '995e66b8-6f00-4407-8996-98b714c1fbca',
        isActive: false,
        metadata: [],
        name: 'cogo',
        rate: 1,
        updatedAt: Utils\Utils::parseDateTime('2025-11-05T05:28:55.762Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingTaxrateRequest(
    accountingTaxrate: new Shared\AccountingTaxrate(
        createdAt: Utils\Utils::parseDateTime('2020-01-04T10:37:56.894Z'),
        description: 'Nemo atrox tricesimus creator aranea.',
        id: '88ed361d-e87b-42c1-a6c3-57d4514c66b7',
        isActive: false,
        metadata: [],
        name: 'cogo',
        rate: 1,
        updatedAt: Utils\Utils::parseDateTime('2025-11-05T05:28:55.772Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
