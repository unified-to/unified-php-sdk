...
$request = new Operations\CreateHrisBankaccountRequest(
    hrisBankaccount: new Shared\HrisBankaccount(
        ...
        id: '3db1488e-d8aa-4b2c-96f8-d07444acdcd5',
        isPrimary: false,
        name: 'Checking Account',
        routingNumber: '448650724',
        updatedAt: Utils\Utils::parseDateTime('2025-06-05T07:38:56.636Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisBenefitRequest(
    hrisBenefit: new Shared\HrisBenefit(
        ...
        id: '47b4f024-8cf7-41e6-8356-45bb3803ea7a',
        isActive: false,
        name: 'Frozen Wooden Ball',
        tax: Shared\Tax::PreTax,
        type: Shared\HrisBenefitType::Garnishment,
        updatedAt: Utils\Utils::parseDateTime('2023-03-06T21:49:32.726Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisCompanyRequest(
    hrisCompany: new Shared\HrisCompany(
        ...
        id: '94733f0b-ffb9-4389-9531-ad762a4a5b06',
        legalName: 'Schultz LLC',
        name: 'Gottlieb Group',
        updatedAt: Utils\Utils::parseDateTime('2026-09-06T21:50:45.317Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisDeductionRequest(
    hrisDeduction: new Shared\HrisDeduction(
        ...
        endAt: Utils\Utils::parseDateTime('2026-05-23T22:27:57.827Z'),
        frequency: Shared\HrisDeductionFrequency::Month,
        id: 'ddced39b-5d18-4292-b5a6-e4025c9d4507',
        isActive: false,
        notes: 'Carmen desidero.',
        startAt: Utils\Utils::parseDateTime('2025-02-18T23:31:19.416Z'),
        type: Shared\HrisDeductionType::Fixed,
        updatedAt: Utils\Utils::parseDateTime('2024-03-02T14:57:43.754Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisDeviceRequest(
    hrisDevice: new Shared\HrisDevice(
        ...
        hasScreenlock: true,
        id: '94a5734d-3325-443a-9241-9cbd51fa7d74',
        isMissing: false,
        ...
        os: 'monitor',
        osVersion: '1.12.16',
        updatedAt: Utils\Utils::parseDateTime('2023-05-21T14:40:14.018Z'),
        version: '2.20.17',
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisDocumentRequest(
    hrisDocument: new Shared\HrisDocument(
        ...
        id: '6392be0b-6dc6-4d83-9b71-dd097bbdee18',
        type: Shared\HrisDocumentType::Policy,
        updatedAt: Utils\Utils::parseDateTime('2025-09-17T20:20:15.869Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisEmployeeRequest(
    hrisEmployee: new Shared\HrisEmployee(
        ...
        hasMfa: true,
        hiredAt: Utils\Utils::parseDateTime('2023-05-11T05:09:39.840Z'),
        id: 'ed036759-35ea-44ed-af63-26762b401099',
        ...
        metadata: [
            new Shared\HrisMetadata(
                ...
                id: '235af215-f874-4335-9438-f7a748319e75',
                namespace: 'custom',
        ...
        updatedAt: Utils\Utils::parseDateTime('2022-02-19T15:37:49.062Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisGroupRequest(
    hrisGroup: new Shared\HrisGroup(
        ...
        id: '3d229191-8ee1-47a2-945e-02c5eeee45e1',
        isActive: false,
        name: 'Games',
        type: Shared\HrisGroupType::BusinessUnit,
        updatedAt: Utils\Utils::parseDateTime('2026-04-24T11:44:52.586Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisLocationRequest(
    hrisLocation: new Shared\HrisLocation(
        ...
        externalIdentifier: '10782486-9118-4130-900d-7fc4aca74742',
        id: '9d1c89c6-379b-4448-9a21-51ed96105541',
        isActive: true,
        isHq: false,
        languageLocale: 'fr',
        name: 'adhuc',
        ...
        updatedAt: Utils\Utils::parseDateTime('2023-06-09T09:44:37.938Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateHrisTimeoffRequest(
    hrisTimeoff: new Shared\HrisTimeoff(
        approvedAt: Utils\Utils::parseDateTime('2022-02-20T22:55:36.417Z'),
        ...
        endAt: Utils\Utils::parseDateTime('2024-12-08T05:44:51.508Z'),
        id: '7a6a31b3-82f0-404a-9f97-bb6e3d306ec4',
        isPaid: true,
        originalType: 'acerbitas ut',
        reason: 'verto',
        startAt: Utils\Utils::parseDateTime('2023-08-23T16:21:33.729Z'),
        status: Shared\HrisTimeoffStatus::Denied,
        type: Shared\HrisTimeoffType::InLieu,
        updatedAt: Utils\Utils::parseDateTime('2022-07-07T23:20:42.422Z'),
        userId: '<id>',
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchHrisBankaccountRequest(
    hrisBankaccount: new Shared\HrisBankaccount(
        ...
        bankName: 'Huel Group',
        createdAt: Utils\Utils::parseDateTime('2019-11-16T16:43:45.976Z'),
        id: '1dd05788-9c52-4961-a6b8-d9f9d486e3f1',
        isPrimary: false,
        name: 'Checking Account',
        routingNumber: '448650724',
        updatedAt: Utils\Utils::parseDateTime('2025-06-05T07:38:56.640Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisBenefitRequest(
    hrisBenefit: new Shared\HrisBenefit(
        ...
        employerContributionType: Shared\EmployerContributionType::Percentage,
        frequency: Shared\HrisBenefitFrequency::Hour,
        id: '51f88d2a-4597-4a62-96e0-fe3f32e50052',
        isActive: false,
        name: 'Frozen Wooden Ball',
        tax: Shared\Tax::PreTax,
        type: Shared\HrisBenefitType::Garnishment,
        updatedAt: Utils\Utils::parseDateTime('2023-03-06T21:49:32.731Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisCompanyRequest(
    hrisCompany: new Shared\HrisCompany(
        ...
        createdAt: Utils\Utils::parseDateTime('2021-05-02T22:27:38.970Z'),
        id: '8b702fc1-4cbf-4f84-b846-ab67589da4e4',
        legalName: 'Schultz LLC',
        name: 'Gottlieb Group',
        updatedAt: Utils\Utils::parseDateTime('2026-09-06T21:50:45.330Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisDeductionRequest(
    hrisDeduction: new Shared\HrisDeduction(
        ...
        coverageLevel: Shared\HrisDeductionCoverageLevel::EmployeeOnly,
        createdAt: Utils\Utils::parseDateTime('2020-02-05T01:46:31.384Z'),
        endAt: Utils\Utils::parseDateTime('2026-05-23T22:27:57.834Z'),
        frequency: Shared\HrisDeductionFrequency::Month,
        id: '18b38578-ff19-44f8-add7-d67c637da958',
        isActive: false,
        notes: 'Carmen desidero.',
        startAt: Utils\Utils::parseDateTime('2025-02-18T23:31:19.421Z'),
        type: Shared\HrisDeductionType::Fixed,
        updatedAt: Utils\Utils::parseDateTime('2024-03-02T14:57:43.758Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisDeviceRequest(
    hrisDevice: new Shared\HrisDevice(
        ...
        hasPasswordManager: true,
        hasScreenlock: true,
        id: 'ef69180e-6279-4fde-9318-4db268b80d1a',
        isMissing: false,
        manufacturer: 'Sanford - Hamill',
        model: 'Refined',
        name: 'cross_contamination_if.rar',
        os: 'monitor',
        osVersion: '1.12.16',
        updatedAt: Utils\Utils::parseDateTime('2023-05-21T14:40:14.023Z'),
        version: '2.20.17',
    ),
    connectionId: '<id>',
    id: '<id>',
...
$request = new Operations\PatchHrisDocumentRequest(
    hrisDocument: new Shared\HrisDocument(
        ...
        documentUrl: 'https://sore-decision.biz/',
        filename: 'ridge_forager.xsl',
        id: '0afedeb1-53e5-40fd-9d68-dfd5fc7e4886',
        type: Shared\HrisDocumentType::Policy,
        updatedAt: Utils\Utils::parseDateTime('2025-09-17T20:20:15.874Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisEmployeeRequest(
    hrisEmployee: new Shared\HrisEmployee(
        ...
        gender: Shared\HrisEmployeeGender::Intersex,
        hasMfa: true,
        hiredAt: Utils\Utils::parseDateTime('2023-05-11T05:09:39.890Z'),
        id: '881397b9-43b9-4d08-803f-472a4d6fe31c',
        imageUrl: 'https://loremflickr.com/3684/2116?lock=4686991638584456',
        languageLocale: 'es',
        lastName: 'Prohaska',
        locations: [],
        ...
        metadata: [
            new Shared\HrisMetadata(
                ...
                format: Shared\HrisMetadataFormat::Text,
                id: '77ed9489-eb68-4522-87e9-ba9d6c36b1af',
                namespace: 'custom',
                slug: 'custom_property',
                value: 'tenetur',
            ),
        ...
        timezone: 'Africa/Harare',
        title: 'Investor Paradigm Liaison',
        updatedAt: Utils\Utils::parseDateTime('2022-02-19T15:37:49.095Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisGroupRequest(
    hrisGroup: new Shared\HrisGroup(
        createdAt: Utils\Utils::parseDateTime('2023-11-01T13:13:40.714Z'),
        description: 'Absorbeo casso.',
        id: '226bb021-88d5-4056-b79b-bb75f651aacc',
        isActive: false,
        name: 'Games',
        type: Shared\HrisGroupType::BusinessUnit,
        updatedAt: Utils\Utils::parseDateTime('2026-04-24T11:44:52.591Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisLocationRequest(
    hrisLocation: new Shared\HrisLocation(
        ...
        currency: 'MUR',
        description: 'Acervus caries.',
        externalIdentifier: '184a405d-bb9d-46f6-88d5-af1b310357d0',
        id: 'd8526f97-0f96-4927-833b-17c493d67bee',
        isActive: true,
        isHq: false,
        languageLocale: 'fr',
        name: 'adhuc',
        ...
        timezone: 'America/Guyana',
        updatedAt: Utils\Utils::parseDateTime('2023-06-09T09:44:37.945Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchHrisTimeoffRequest(
    hrisTimeoff: new Shared\HrisTimeoff(
        ...
        duration: 4,
        durationType: Shared\DurationType::Day,
        endAt: Utils\Utils::parseDateTime('2024-12-08T05:44:51.514Z'),
        id: 'f10ad7b7-8606-43c5-a4cc-e20e653bafcf',
        isPaid: true,
        originalType: 'acerbitas ut',
        reason: 'verto',
        startAt: Utils\Utils::parseDateTime('2023-08-23T16:21:33.733Z'),
        status: Shared\HrisTimeoffStatus::Denied,
        type: Shared\HrisTimeoffType::InLieu,
        updatedAt: Utils\Utils::parseDateTime('2022-07-07T23:20:42.423Z'),
        userId: '<id>',
    ),
    connectionId: '<id>',
    id: '<id>',
