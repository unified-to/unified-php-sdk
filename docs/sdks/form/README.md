    ...
    formsForm: new Shared\FormsForm(
        ...
        fields: [
            new Shared\FormField(
                ...
                updatedAt: Utils\Utils::parseDateTime('2025-04-12T17:47:20.757Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                ...
                order: 1,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-08-23T21:25:52.011Z'),
            ),
            new Shared\FormField(
                choices: [
                    'vallum',
                ...
                updatedAt: Utils\Utils::parseDateTime('2024-02-22T08:23:57.015Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                ...
                order: 3,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-11-15T17:41:15.948Z'),
            ),
        ],
        ...
        responseCount: 423,
        updatedAt: Utils\Utils::parseDateTime('2024-08-15T18:17:43.740Z'),
    ),
    connectionId: '<id>',
);
    ...
    formsForm: new Shared\FormsForm(
        ...
        fields: [
            new Shared\FormField(
                ...
                order: 0,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2025-04-12T17:47:20.769Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                id: '82b263f9-2d16-4cdf-8e99-d05ba46ce817',
                ...
                order: 1,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-08-23T21:25:52.018Z'),
            ),
            new Shared\FormField(
                choices: [
                    'vallum',
                ...
                order: 2,
                type: Shared\FormFieldType::MultipleSelect,
                updatedAt: Utils\Utils::parseDateTime('2024-02-22T08:23:57.018Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                description: 'Sequi antea delectatio.',
                ...
                order: 3,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-11-15T17:41:15.957Z'),
            ),
        ],
        hasMultipleSubmissions: false,
        hasProgressBar: false,
        ...
        publishedUrl: 'https://impartial-institute.org/',
        responseCount: 423,
        updatedAt: Utils\Utils::parseDateTime('2024-08-15T18:17:43.747Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
