    ...
    formsForm: new Shared\FormsForm(
        ...
        fields: [
            new Shared\FormField(
                ...
                updatedAt: Utils\Utils::parseDateTime('2025-04-13T03:46:38.973Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                ...
                order: 1,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-08-24T03:14:44.606Z'),
            ),
            new Shared\FormField(
                choices: [
                    'vallum',
                ...
                updatedAt: Utils\Utils::parseDateTime('2024-02-22T10:54:34.556Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                ...
                order: 3,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-11-16T01:00:42.306Z'),
            ),
        ],
        hasMultipleSubmissions: false,
        hasProgressBar: false,
        hasShuffleQuestions: true,
        id: '6b1ab5bc-fe01-496f-a046-e75f9fdc7a7a',
        isActive: false,
        name: 'voluptatibus omnis audax Form',
        publishedUrl: 'https://impartial-institute.org/',
        responseCount: 423,
        updatedAt: Utils\Utils::parseDateTime('2024-08-15T23:57:49.404Z'),
    ),
    connectionId: '<id>',
);

$response = $sdk->form->createFormsForm(
    request: $request
);
...
$response = $sdk->form->getFormsForm(
    request: $request
);
...
$response = $sdk->form->listFormsForms(
    request: $request
);
    ...
    formsForm: new Shared\FormsForm(
        ...
        fields: [
            new Shared\FormField(
                ...
                order: 0,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2025-04-13T03:46:38.979Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                id: '82b263f9-2d16-4cdf-8e99-d05ba46ce817',
                ...
                order: 1,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-08-24T03:14:44.610Z'),
            ),
            new Shared\FormField(
                choices: [
                    'vallum',
                ...
                order: 2,
                type: Shared\FormFieldType::MultipleSelect,
                updatedAt: Utils\Utils::parseDateTime('2024-02-22T10:54:34.558Z'),
            ),
            new Shared\FormField(
                createdAt: Utils\Utils::parseDateTime('2023-10-05T21:34:29.094Z'),
                description: 'Sequi antea delectatio.',
                ...
                order: 3,
                type: Shared\FormFieldType::Textarea,
                updatedAt: Utils\Utils::parseDateTime('2024-11-16T01:00:42.311Z'),
            ),
        ],
        hasMultipleSubmissions: false,
        hasProgressBar: false,
        hasShuffleQuestions: true,
        id: '5bed6f24-6562-40be-bf07-e611bb02b992',
        isActive: false,
        name: 'voluptatibus omnis audax Form',
        publishedUrl: 'https://impartial-institute.org/',
        responseCount: 423,
        updatedAt: Utils\Utils::parseDateTime('2024-08-15T23:57:49.408Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);

$response = $sdk->form->patchFormsForm(
    request: $request
);
...
$response = $sdk->form->removeFormsForm(
    request: $request
);
...
$response = $sdk->form->updateFormsForm(
    request: $request
);
