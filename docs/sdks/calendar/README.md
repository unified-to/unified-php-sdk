...
$request = new Operations\CreateCalendarCalendarRequest(
    calendarCalendar: new Shared\CalendarCalendar(
        ...
        updatedAt: Utils\Utils::parseDateTime('2023-03-13T10:45:03.071Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateCalendarEventRequest(
    calendarEvent: new Shared\CalendarEvent(
        ...
        endAt: '2020-05-20T20:02:06.557Z',
        ...
        recurrence: [
            new Shared\CalendarEventRecurrence(
                count: 8,
                endAt: Utils\Utils::parseDateTime('2025-12-27T05:19:21.214Z'),
                excludedDates: [
            ...
            new Shared\CalendarEventRecurrence(
                count: 9,
                endAt: Utils\Utils::parseDateTime('2025-05-01T02:16:53.539Z'),
                excludedDates: [
            ...
            new Shared\CalendarEventRecurrence(
                count: 1,
                endAt: Utils\Utils::parseDateTime('2020-11-04T22:21:34.626Z'),
                excludedDates: [
        ...
        recurringEventId: 'fd7d1734-8fa9-4bb3-a839-f97e8353be38',
        sendNotifications: false,
        startAt: '2020-05-20T10:55:00.408Z',
        status: Shared\CalendarEventStatus::Confirmed,
        subject: 'Sunt spargo tepidus bestia vigor credo coadunatio appello.',
        timezone: 'Asia/Bangkok',
        updatedAt: '2020-06-26T07:58:34.744Z',
...
$request = new Operations\PatchCalendarCalendarRequest(
    calendarCalendar: new Shared\CalendarCalendar(
        ...
        name: 'Acer supra vallum suasoria thesaurus omnis condico cognomen accendo vehemens.',
        timezone: 'America/Dawson_Creek',
        updatedAt: Utils\Utils::parseDateTime('2023-03-13T10:45:03.075Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchCalendarEventRequest(
    calendarEvent: new Shared\CalendarEvent(
        ...
        conference: [],
        createdAt: '2019-08-04T14:33:51.814Z',
        endAt: '2020-05-20T20:02:06.562Z',
        ...
        recurrence: [
            new Shared\CalendarEventRecurrence(
                count: 8,
                endAt: Utils\Utils::parseDateTime('2025-12-27T05:19:21.258Z'),
                excludedDates: [
            ...
            new Shared\CalendarEventRecurrence(
                count: 9,
                endAt: Utils\Utils::parseDateTime('2025-05-01T02:16:53.577Z'),
                excludedDates: [
            ...
            new Shared\CalendarEventRecurrence(
                count: 1,
                endAt: Utils\Utils::parseDateTime('2020-11-04T22:21:34.635Z'),
                excludedDates: [
        ...
        recurringEventId: '892d0b90-62fb-44a9-ab72-93756ddbda5d',
        sendNotifications: false,
        startAt: '2020-05-20T10:55:00.413Z',
        status: Shared\CalendarEventStatus::Confirmed,
        subject: 'Sunt spargo tepidus bestia vigor credo coadunatio appello.',
        timezone: 'Asia/Bangkok',
        updatedAt: '2020-06-26T07:58:34.750Z',
        webUrl: 'https://another-pinstripe.com',
    ),
    connectionId: '<id>',
    id: '<id>',
