...
$request = new Operations\CreateCalendarCalendarRequest(
    calendarCalendar: new Shared\CalendarCalendar(
        ...
        id: '8f2fe186-492f-4fb6-b696-98a39428dbbe',
        isPrimary: false,
        name: 'Acer supra vallum suasoria thesaurus omnis condico cognomen accendo vehemens.',
        timezone: 'America/Dawson_Creek',
        updatedAt: Utils\Utils::parseDateTime('2023-03-12T12:08:46.702Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateCalendarEventRequest(
    calendarEvent: new Shared\CalendarEvent(
        ...
        endAt: '2020-05-20T14:42:59.889Z',
        id: 'c5e1f7a3-b61f-4e5d-843a-676e0582b7ff',
        isAllDay: false,
        isFree: false,
        isPrivate: false,
        ...
        recurrence: [
            new Shared\CalendarEventRecurrence(
                count: 8,
                endAt: Utils\Utils::parseDateTime('2025-12-25T10:30:12.078Z'),
                excludedDates: [
                    '2025-09-30T03:22:34.253Z',
                    '2023-10-08T23:06:28.007Z',
                    '2024-02-14T23:06:17.807Z',
                ],
                frequency: Shared\CalendarEventRecurrenceFrequency::Monthly,
                includedDates: [
                    '2021-02-16T17:14:00.485Z',
                ],
                interval: 4,
                onDays: [
            ...
            new Shared\CalendarEventRecurrence(
                count: 9,
                endAt: Utils\Utils::parseDateTime('2025-04-29T11:51:45.833Z'),
                excludedDates: [
                    '2020-04-28T22:24:54.607Z',
                ],
                frequency: Shared\CalendarEventRecurrenceFrequency::Daily,
                includedDates: [
                    '2020-09-10T23:06:10.729Z',
                    '2021-11-28T18:10:46.941Z',
                    '2019-12-22T16:53:48.397Z',
                ],
                interval: 1,
                onDays: [
            ...
            new Shared\CalendarEventRecurrence(
                count: 1,
                endAt: Utils\Utils::parseDateTime('2020-11-04T13:57:38.419Z'),
                excludedDates: [
                    '2023-01-11T10:46:38.887Z',
                    '2021-09-07T06:47:09.104Z',
                ],
                frequency: Shared\CalendarEventRecurrenceFrequency::Weekly,
                includedDates: [
                    '2024-08-30T19:02:32.742Z',
                ],
                interval: 9,
                onDays: [
                    Shared\PropertyCalendarEventRecurrenceOnDays::Tu,
        ...
        recurringEventId: 'a9d9402f-2b05-463c-a299-01f36c55f0a9',
        sendNotifications: false,
        startAt: '2020-05-20T05:36:18.805Z',
        status: Shared\CalendarEventStatus::Confirmed,
        subject: 'Sunt spargo tepidus bestia vigor credo coadunatio appello.',
        timezone: 'Asia/Bangkok',
        updatedAt: '2020-06-26T01:59:20.292Z',
...
$request = new Operations\PatchCalendarCalendarRequest(
    calendarCalendar: new Shared\CalendarCalendar(
        createdAt: Utils\Utils::parseDateTime('2020-01-09T23:11:34.147Z'),
        description: 'Socius catena auxilium.',
        id: '7bb4b8e7-3465-43e5-832b-8dda75c22369',
        isPrimary: false,
        name: 'Acer supra vallum suasoria thesaurus omnis condico cognomen accendo vehemens.',
        timezone: 'America/Dawson_Creek',
        updatedAt: Utils\Utils::parseDateTime('2023-03-12T12:08:46.705Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchCalendarEventRequest(
    calendarEvent: new Shared\CalendarEvent(
        ...
        conference: [],
        createdAt: '2019-08-04T14:33:51.814Z',
        endAt: '2020-05-20T14:42:59.895Z',
        id: 'ec092c04-fb6e-48a5-a64f-83e82194bf0d',
        isAllDay: false,
        isFree: false,
        isPrivate: false,
        location: '621 Boehm Prairie',
        ...
        recurrence: [
            new Shared\CalendarEventRecurrence(
                count: 8,
                endAt: Utils\Utils::parseDateTime('2025-12-25T10:30:12.122Z'),
                excludedDates: [
                    '2025-09-30T03:22:34.295Z',
                    '2023-10-08T23:06:28.036Z',
                    '2024-02-14T23:06:17.839Z',
                ],
                frequency: Shared\CalendarEventRecurrenceFrequency::Monthly,
                includedDates: [
                    '2021-02-16T17:14:00.495Z',
                ],
                interval: 4,
                onDays: [
                    Shared\PropertyCalendarEventRecurrenceOnDays::Th,
            ...
            new Shared\CalendarEventRecurrence(
                count: 9,
                endAt: Utils\Utils::parseDateTime('2025-04-29T11:51:45.873Z'),
                excludedDates: [
                    '2020-04-28T22:24:54.612Z',
                ],
                frequency: Shared\CalendarEventRecurrenceFrequency::Daily,
                includedDates: [
                    '2020-09-10T23:06:10.737Z',
                    '2021-11-28T18:10:46.957Z',
                    '2019-12-22T16:53:48.399Z',
                ],
                interval: 1,
                onDays: [
                    Shared\PropertyCalendarEventRecurrenceOnDays::We,
            ...
            new Shared\CalendarEventRecurrence(
                count: 1,
                endAt: Utils\Utils::parseDateTime('2020-11-04T13:57:38.428Z'),
                excludedDates: [
                    '2023-01-11T10:46:38.910Z',
                    '2021-09-07T06:47:09.118Z',
                ],
                frequency: Shared\CalendarEventRecurrenceFrequency::Weekly,
                includedDates: [
                    '2024-08-30T19:02:32.777Z',
                ],
                interval: 9,
                onDays: [
                    Shared\PropertyCalendarEventRecurrenceOnDays::Tu,
        ...
        recurringEventId: 'ad61f948-2c46-4525-b8eb-fd2fc3e80bc7',
        sendNotifications: false,
        startAt: '2020-05-20T05:36:18.811Z',
        status: Shared\CalendarEventStatus::Confirmed,
        subject: 'Sunt spargo tepidus bestia vigor credo coadunatio appello.',
        timezone: 'Asia/Bangkok',
        updatedAt: '2020-06-26T01:59:20.298Z',
        webUrl: 'https://another-pinstripe.com',
    ),
    connectionId: '<id>',
    id: '<id>',
