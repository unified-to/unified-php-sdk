...
$request = new Operations\CreateAccountingJournalRequest(
    accountingJournal: new Shared\AccountingJournal(
        ...
        id: '44bd2a34-3798-47e2-873f-a70a03ec35ed',
        postedAt: Utils\Utils::parseDateTime('2023-10-19T15:40:10.872Z'),
        reference: 'ullam',
        source: 'crustulum',
        taxAmount: 78672,
        updatedAt: Utils\Utils::parseDateTime('2022-01-01T18:10:48.867Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingJournalRequest(
    accountingJournal: new Shared\AccountingJournal(
        ...
        currency: 'FKP',
        description: 'Calco constans adipisci.',
        id: '93b93a17-eac3-4416-adc5-4d752fa3b742',
        postedAt: Utils\Utils::parseDateTime('2023-10-19T15:40:10.879Z'),
        reference: 'ullam',
        source: 'crustulum',
        taxAmount: 78672,
        updatedAt: Utils\Utils::parseDateTime('2022-01-01T18:10:48.871Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
