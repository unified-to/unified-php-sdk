...
$request = new Operations\CreateAdsCampaignRequest(
    adsCampaign: new Shared\AdsCampaign(
        ...
        endAt: Utils\Utils::parseDateTime('2025-05-10T17:01:10.791Z'),
        id: 'b1b4c3e4-c0c5-47e9-bdb2-65bef9009dcb',
        labels: [
            'comedo',
        ],
        name: 'Emard Inc',
        startAt: Utils\Utils::parseDateTime('2022-07-20T06:39:41.501Z'),
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-12-07T04:38:34.303Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAdsGroupRequest(
    adsGroup: new Shared\AdsGroup(
        ...
        endAt: Utils\Utils::parseDateTime('2026-05-26T10:50:57.393Z'),
        id: 'a8470d23-bde4-42b9-a08a-e2f4c752a8b0',
        languageLocale: 'fr-FR',
        name: 'Stark - Baumbach',
        startAt: Utils\Utils::parseDateTime('2025-12-12T15:40:05.126Z'),
        status: Shared\AdsGroupStatus::Processing,
        targeting: new Shared\PropertyAdsGroupTargeting(),
        updatedAt: Utils\Utils::parseDateTime('2022-01-03T08:37:42.016Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAdsCampaignRequest(
    adsCampaign: new Shared\AdsCampaign(
        ...
        currency: 'USD',
        effectiveStatus: Shared\EffectiveStatus::NotEligible,
        endAt: Utils\Utils::parseDateTime('2025-05-10T17:01:10.904Z'),
        id: '67e98d0f-b6d4-4951-b1ea-28ed039fdc1e',
        labels: [
            'comedo',
        ],
        name: 'Emard Inc',
        startAt: Utils\Utils::parseDateTime('2022-07-20T06:39:41.508Z'),
        status: Shared\AdsCampaignStatus::ProcessingFailed,
        targeting: new Shared\PropertyAdsCampaignTargeting(),
        totalSpendAmount: 2349.8642875347286,
        updatedAt: Utils\Utils::parseDateTime('2025-12-07T04:38:34.437Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAdsGroupRequest(
    adsGroup: new Shared\AdsGroup(
        ...
        currency: 'USD',
        effectiveStatus: Shared\AdsGroupEffectiveStatus::Paused,
        endAt: Utils\Utils::parseDateTime('2026-05-26T10:50:57.548Z'),
        id: '1140364c-1ab5-40e7-ae03-fe207bb1cb7c',
        languageLocale: 'fr-FR',
        name: 'Stark - Baumbach',
        startAt: Utils\Utils::parseDateTime('2025-12-12T15:40:05.270Z'),
        status: Shared\AdsGroupStatus::Processing,
        targeting: new Shared\PropertyAdsGroupTargeting(),
        updatedAt: Utils\Utils::parseDateTime('2022-01-03T08:37:42.070Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
