...
$request = new Operations\CreateAdsAdRequest(
    adsAd: new Shared\AdsAd(
        ...
        updatedAt: Utils\Utils::parseDateTime('2024-06-06T06:01:10.224Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAdsAssetRequest(
    adsAsset: new Shared\AdsAsset(
        ...
        updatedAt: Utils\Utils::parseDateTime('2022-03-16T00:46:55.527Z'),
...
$request = new Operations\CreateAdsGroupRequest(
    adsGroup: new Shared\AdsGroup(
        ...
        endAt: Utils\Utils::parseDateTime('2026-05-27T05:24:51.203Z'),
        id: '3b918eb8-60d5-447a-8f17-b874f9a7d7ec',
        languageLocale: 'fr-FR',
        name: 'Stark - Baumbach',
        startAt: Utils\Utils::parseDateTime('2025-12-13T08:59:24.731Z'),
        status: Shared\AdsGroupStatus::Processing,
        targeting: new Shared\PropertyAdsGroupTargeting(),
        updatedAt: Utils\Utils::parseDateTime('2022-01-03T15:05:45.630Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAdsInsertionorderRequest(
    adsInsertionorder: new Shared\AdsInsertionorder(
        ...
        updatedAt: Utils\Utils::parseDateTime('2021-04-28T13:08:20.151Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAdsAdRequest(
    adsAd: new Shared\AdsAd(
        ...
        name: 'Hermiston Group',
        status: Shared\AdsAdStatus::Archived,
        updatedAt: Utils\Utils::parseDateTime('2024-06-06T06:01:10.235Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchAdsGroupRequest(
    adsGroup: new Shared\AdsGroup(
        ...
        currency: 'USD',
        effectiveStatus: Shared\AdsGroupEffectiveStatus::Paused,
        endAt: Utils\Utils::parseDateTime('2026-05-27T05:24:51.368Z'),
        id: '9728b762-cded-4c37-886b-79bd28ad26ea',
        languageLocale: 'fr-FR',
        name: 'Stark - Baumbach',
        startAt: Utils\Utils::parseDateTime('2025-12-13T08:59:24.886Z'),
        status: Shared\AdsGroupStatus::Processing,
        targeting: new Shared\PropertyAdsGroupTargeting(),
        updatedAt: Utils\Utils::parseDateTime('2022-01-03T15:05:45.688Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
