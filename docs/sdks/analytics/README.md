...
$request = new Operations\CreateAnalyticsPropertyRequest(
    analyticsProperty: new Shared\AnalyticsProperty(
        ...
        timezone: 'UTC',
        updatedAt: Utils\Utils::parseDateTime('2021-09-14T16:55:47.263Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAnalyticsVisitorRequest(
    analyticsVisitor: new Shared\AnalyticsVisitor(
        ...
        lastSeenAt: Utils\Utils::parseDateTime('2021-12-05T11:14:39.995Z'),
        metadata: [
            'segment' => new Shared\PropertyAnalyticsVisitorMetadata(),
        ],
        name: 'Desiree O\'Hara',
        totalEvents: 3639,
        updatedAt: Utils\Utils::parseDateTime('2025-06-05T14:06:35.345Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAnalyticsVisitorRequest(
    analyticsVisitor: new Shared\AnalyticsVisitor(
        ...
        lastSeenAt: Utils\Utils::parseDateTime('2021-12-05T11:14:39.997Z'),
        metadata: [
            'segment' => new Shared\PropertyAnalyticsVisitorMetadata(),
        ],
        name: 'Desiree O\'Hara',
        totalEvents: 3639,
        updatedAt: Utils\Utils::parseDateTime('2025-06-05T14:06:35.353Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
