...
$request = new Operations\CreateAnalyticsPropertyRequest(
    analyticsProperty: new Shared\AnalyticsProperty(
        ...
        timezone: 'UTC',
        updatedAt: Utils\Utils::parseDateTime('2021-09-14T16:50:08.480Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateAnalyticsVisitorRequest(
    analyticsVisitor: new Shared\AnalyticsVisitor(
        ...
        lastSeenAt: Utils\Utils::parseDateTime('2021-12-05T06:17:43.707Z'),
        metadata: [
            'segment' => new Shared\PropertyAnalyticsVisitorMetadata(),
        ],
        name: 'Desiree O\'Hara',
        totalEvents: 3639,
        updatedAt: Utils\Utils::parseDateTime('2025-06-04T22:34:35.324Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAnalyticsVisitorRequest(
    analyticsVisitor: new Shared\AnalyticsVisitor(
        ...
        lastSeenAt: Utils\Utils::parseDateTime('2021-12-05T06:17:43.710Z'),
        metadata: [
            'segment' => new Shared\PropertyAnalyticsVisitorMetadata(),
        ],
        name: 'Desiree O\'Hara',
        totalEvents: 3639,
        updatedAt: Utils\Utils::parseDateTime('2025-06-04T22:34:35.336Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
