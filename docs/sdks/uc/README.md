...
$request = new Operations\CreateUcCommentRequest(
    ucComment: new Shared\UcComment(
        ...
        id: '5b07fd0e-a5a0-43f1-b893-f901ee01f164',
        updatedAt: '2024-02-02T01:28:06.487Z',
    ),
    connectionId: '<id>',
);
...
$request = new Operations\CreateUcRecordingRequest(
    ucRecording: new Shared\UcRecording(
        ...
        endAt: Utils\Utils::parseDateTime('2024-04-22T06:18:10.506Z'),
        expiresAt: Utils\Utils::parseDateTime('2026-03-29T14:13:08.470Z'),
        id: 'f374502d-94ef-4033-ade4-fd0f770e487d',
        media: [],
        startAt: Utils\Utils::parseDateTime('2023-04-23T00:06:29.151Z'),
        type: Shared\UcRecordingType::Inbound,
        updatedAt: Utils\Utils::parseDateTime('2025-02-24T23:31:03.744Z'),
...
$request = new Operations\PatchUcCommentRequest(
    ucComment: new Shared\UcComment(
        content: 'Vociferor vitiosus.',
        createdAt: '2023-04-02T23:42:31.571Z',
        id: '72210f96-6973-4d76-afab-e9c318909451',
        updatedAt: '2024-02-02T01:28:06.488Z',
    ),
    connectionId: '<id>',
    id: '<id>',
);
...
$request = new Operations\PatchUcRecordingRequest(
    ucRecording: new Shared\UcRecording(
        contacts: [],
        createdAt: Utils\Utils::parseDateTime('2022-09-17T19:41:46.956Z'),
        endAt: Utils\Utils::parseDateTime('2024-04-22T06:18:10.512Z'),
        expiresAt: Utils\Utils::parseDateTime('2026-03-29T14:13:08.483Z'),
        id: '0d41fda0-59b5-488b-96f7-a0972b129d71',
        media: [],
        startAt: Utils\Utils::parseDateTime('2023-04-23T00:06:29.153Z'),
        type: Shared\UcRecordingType::Inbound,
        updatedAt: Utils\Utils::parseDateTime('2025-02-24T23:31:03.752Z'),
        userName: 'Melyna Larson',
        userPhone: '1-915-327-0429 x509',
        webUrl: 'https://spherical-comparison.org',
    ),
