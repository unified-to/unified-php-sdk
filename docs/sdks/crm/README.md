...
$request = new Operations\CreateCrmCompanyRequest(
    crmCompany: new Shared\CrmCompany(
        ...
        updatedAt: Utils\Utils::parseDateTime('2025-02-07T07:04:22.586Z'),
        websites: [
...
$request = new Operations\CreateCrmEventRequest(
    crmEvent: new Shared\CrmEvent(
        call: new Shared\PropertyCrmEventCall(
            ...
            duration: 64,
            startAt: Utils\Utils::parseDateTime('2024-11-18T13:02:48.676Z'),
        ),
        ...
        updatedAt: Utils\Utils::parseDateTime('2026-09-09T16:49:53.775Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchCrmCompanyRequest(
    crmCompany: new Shared\CrmCompany(
        ...
        timezone: 'Europe/San_Marino',
        updatedAt: Utils\Utils::parseDateTime('2025-02-07T07:04:22.599Z'),
        websites: [
            'https://wise-possession.org',
        ],
    ),
...
$request = new Operations\PatchCrmEventRequest(
    crmEvent: new Shared\CrmEvent(
        call: new Shared\PropertyCrmEventCall(
            description: 'Arbitro aptus.',
            duration: 64,
            startAt: Utils\Utils::parseDateTime('2024-11-18T13:02:48.695Z'),
        ),
        createdAt: Utils\Utils::parseDateTime('2020-07-14T04:53:23.784Z'),
        id: '29eea139-f78c-455f-bd09-72cea83a7f77',
        type: Shared\CrmEventType::Call,
        updatedAt: Utils\Utils::parseDateTime('2026-09-09T16:49:53.802Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
