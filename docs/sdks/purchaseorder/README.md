...
$request = new Operations\CreateAccountingPurchaseorderRequest(
    accountingPurchaseorder: new Shared\AccountingPurchaseorder(
        ...
        lineitems: [],
        metadata: [],
        postedAt: Utils\Utils::parseDateTime('2025-04-26T15:39:01.708Z'),
        ...
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2021-02-26T05:01:51.111Z'),
    ),
    connectionId: '<id>',
);
...
$request = new Operations\PatchAccountingPurchaseorderRequest(
    accountingPurchaseorder: new Shared\AccountingPurchaseorder(
        ...
        lineitems: [],
        metadata: [],
        postedAt: Utils\Utils::parseDateTime('2025-04-26T15:39:01.752Z'),
        shippingAddress: new Shared\PropertyAccountingPurchaseorderShippingAddress(
            address1: '649 Maggio Overpass',
            city: 'Lake Jaylan',
            countryCode: 'US',
        ...
        status: Shared\AccountingPurchaseorderStatus::PartiallyRefunded,
        totalAmount: 0,
        updatedAt: Utils\Utils::parseDateTime('2021-02-26T05:01:51.113Z'),
    ),
    connectionId: '<id>',
    id: '<id>',
);
