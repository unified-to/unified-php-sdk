...
try {
    ...
    $response = $sdk->file->createStorageFile($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->file->getStorageFile($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->file->listStorageFiles($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->file->patchStorageFile($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->file->removeStorageFile($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->file->updateStorageFile($request, $requestSecurity);
