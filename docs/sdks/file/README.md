...
$request = new Operations\CreateStorageFileRequest(
    storageFile: new Shared\StorageFile(
        ...
        id: '9c8a2974-9740-4259-b778-b492f8e856c1',
        mimeType: 'FOLDER',
        name: 'softly.tiff',
        references: [
        ...
        updatedAt: Utils\Utils::parseDateTime('2023-01-28T06:21:50.745Z'),
        version: '1',
...
$request = new Operations\PatchStorageFileRequest(
    storageFile: new Shared\StorageFile(
        ...
        downloadUrl: 'https://stingy-casement.name/',
        hash: 'fe6a659e-75cd-4079-9b76-351f9af2205a',
        id: '25c134fe-1fdc-4428-a037-1410ae874189',
        mimeType: 'FOLDER',
        name: 'softly.tiff',
        references: [
            new Shared\StorageReference(
        ...
        type: Shared\StorageFileType::File,
        updatedAt: Utils\Utils::parseDateTime('2023-01-28T06:21:50.751Z'),
        version: '1',
        webUrl: 'https://sandy-distinction.info/',
    ),
    connectionId: '<id>',
