...
$request = new Operations\CreateUcRecordingRequest(
    ucRecording: new Shared\UcRecording(
        ...
        endAt: Utils\Utils::parseDateTime('2024-04-22T15:25:16.193Z'),
        expiresAt: Utils\Utils::parseDateTime('2026-03-30T10:23:42.009Z'),
        id: 'ca56417e-0a4f-4897-b784-891e71c6258f',
        media: [],
        startAt: Utils\Utils::parseDateTime('2023-04-23T03:30:29.355Z'),
        type: Shared\UcRecordingType::Inbound,
        updatedAt: Utils\Utils::parseDateTime('2025-02-25T13:28:08.344Z'),
...
$request = new Operations\PatchUcRecordingRequest(
    ucRecording: new Shared\UcRecording(
        contacts: [],
        createdAt: Utils\Utils::parseDateTime('2022-09-17T19:41:46.956Z'),
        endAt: Utils\Utils::parseDateTime('2024-04-22T15:25:16.204Z'),
        expiresAt: Utils\Utils::parseDateTime('2026-03-30T10:23:42.033Z'),
        id: '6dc9667a-6877-4250-90cb-91556d15f488',
        media: [],
        startAt: Utils\Utils::parseDateTime('2023-04-23T03:30:29.359Z'),
        type: Shared\UcRecordingType::Inbound,
        updatedAt: Utils\Utils::parseDateTime('2025-02-25T13:28:08.361Z'),
        userName: 'Melyna Larson',
        userPhone: '1-915-327-0429 x509',
        webUrl: 'https://spherical-comparison.org',
    ),
