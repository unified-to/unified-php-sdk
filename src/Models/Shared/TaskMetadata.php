...
class TaskMetadata
{
     ...
     * @phpstan-pure
     */
    public function __construct(array|string|float|bool|null $extraData = null, ?TaskMetadataFormat $format = null, ?string $id = null, ?string $namespace = null, ?string $slug = null, array|string|float|bool|null $value = null)
    {
