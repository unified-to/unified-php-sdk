...
class PropertyAdsReportMetricsGroupTargetingGeographic
{
    /**
     * $cities
     *
    ...
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?PropertyAdsReportMetricsGroupTargetingGeographicPresenceType $presenceType = null;
