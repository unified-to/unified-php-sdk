...
class AccountingMetadata
{
    ...
    /**
     *
     * @var array<string, mixed>|string|float|bool|array<\Unified\Unified_to\Models\Shared\AccountingMetadata1|string|float|bool>|null $value
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('value')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, mixed>|string|float|bool|array<\Unified\Unified_to\Models\Shared\AccountingMetadata1|string|float|bool>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?string  $slug
     * @param  array<string, mixed>|string|float|bool|array<\Unified\Unified_to\Models\Shared\AccountingMetadata1|string|float|bool>|null  $value
     * @phpstan-pure
     */
