...
class AccountingBalancesheetItem
{
     ...
     * $subItems
     *
     * @var ?array<\Unified\Unified_to\Models\Shared\AccountingBalancesheetItem> $subItems
     */
     ...
     * @param  ?float  $amount
     * @param  ?string  $name
     * @param  ?array<\Unified\Unified_to\Models\Shared\AccountingBalancesheetItem>  $subItems
     * @phpstan-pure
     */
