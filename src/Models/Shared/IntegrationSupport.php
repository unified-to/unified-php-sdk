...
class IntegrationSupport
{
    ...
    /**
     *
     * @var array<string, mixed>|string|float|bool|array<IntegrationSupport1|string|float|bool>|null $virtualWebhookBenefitId
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('virtual_webhook_benefit_id')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, mixed>|string|float|bool|array<\Unified\Unified_to\Models\Shared\IntegrationSupport1|string|float|bool>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public array|string|float|bool|null $virtualWebhookBenefitId = null;
    ...
    /**
     *
     * @var array<string, mixed>|string|float|bool|array<IntegrationSupportSchemas1|string|float|bool>|null $virtualWebhookPaymentId
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('virtual_webhook_payment_id')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string, mixed>|string|float|bool|array<\Unified\Unified_to\Models\Shared\IntegrationSupportSchemas1|string|float|bool>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public array|string|float|bool|null $virtualWebhookPaymentId = null;
     ...
     * @param  array<string, mixed>|string|float|bool|array<IntegrationSupport1|string|float|bool>|null  $virtualWebhookBenefitId
     ...
     * @param  array<string, mixed>|string|float|bool|array<IntegrationSupportSchemas1|string|float|bool>|null  $virtualWebhookPaymentId
