...
class PropertyCalendarEventOrganizer
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $email = null, ?bool $isCohost = null, ?string $name = null, ?bool $required = null, ?PropertyCalendarEventOrganizerStatus $status = null, ?string $userId = null)
    {
        $this->email = $email;
