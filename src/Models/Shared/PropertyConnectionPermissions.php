...
enum PropertyConnectionPermissions: string
{
    ...
    case AccountingExpenseRead = 'accounting_expense_read';
    ...
    case AccountingQuoteRead = 'accounting_quote_read';
    case AccountingQuoteWrite = 'accounting_quote_write';
    case AccountingAgedreceivableRead = 'accounting_agedreceivable_read';
    ...
    case CrmTaxonomyRead = 'crm_taxonomy_read';
    ...
    case HrisDeductionRead = 'hris_deduction_read';
    case HrisDeductionWrite = 'hris_deduction_write';
    case HrisBenefitRead = 'hris_benefit_read';
    ...
    case HrisTaxonomyRead = 'hris_taxonomy_read';
    case HrisTaxonomyWrite = 'hris_taxonomy_write';
    ...
    case MessagingChannelWrite = 'messaging_channel_write';
    ...
    case CalendarWebinarRead = 'calendar_webinar_read';
    case CalendarWebinarWrite = 'calendar_webinar_write';
