...
class AdsAd
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $adCopy = null, ?AdType $adType = null, ?string $advertiserName = null, ?string $campaignId = null, ?\DateTime $createdAt = null, ?string $creativeAssetUrl = null, ?array $creativeIds = null, ?string $cta = null, ?string $description = null, ?string $displayUrl = null, ?string $finalUrl = null, ?string $groupId = null, ?string $headline = null, ?string $id = null, ?string $logoCreativeId = null, ?string $name = null, ?string $organizationId = null, ?string $path1 = null, ?string $path2 = null, ?array $promoted = null, ?array $raw = null, ?AdsAdStatus $status = null, ?\DateTime $updatedAt = null)
    {
        $this->adCopy = $adCopy;
        $this->adType = $adType;
