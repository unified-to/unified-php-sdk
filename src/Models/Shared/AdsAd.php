...
class AdsAd
{
    ...
    /**
     *
     * @var ?PropertyAdsAdTargeting $targeting
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('targeting')]
    #[\Speakeasy\Serializer\Annotation\Type('\Unified\Unified_to\Models\Shared\PropertyAdsAdTargeting|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?PropertyAdsAdTargeting $targeting = null;
     ...
     * @param  ?PropertyAdsAdTargeting  $targeting
     * @param  ?\DateTime  $updatedAt
     * @phpstan-pure
     */
    public function __construct(?string $adCopy = null, ?AdType $adType = null, ?string $campaignId = null, ?\DateTime $createdAt = null, ?string $creativeAssetUrl = null, ?array $creativeIds = null, ?string $cta = null, ?string $description = null, ?string $displayUrl = null, ?\DateTime $endAt = null, ?string $finalUrl = null, ?string $groupId = null, ?string $headline = null, ?string $id = null, ?bool $isActive = null, ?string $itemId = null, ?array $metadata = null, ?string $name = null, ?string $organizationId = null, ?string $path1 = null, ?string $path2 = null, ?array $raw = null, ?\DateTime $startAt = null, ?AdsAdStatus $status = null, ?PropertyAdsAdTargeting $targeting = null, ?\DateTime $updatedAt = null)
    {
        $this->adCopy = $adCopy;
        $this->adType = $adType;
