...
class ListCalendarEvents2Request
{
    /**
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListCalendarEvents2QueryParamFields> $fields
     */
     ...
     * @param  ?string  $endLt
     * @param  ?bool  $expand
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListCalendarEvents2QueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $query
