...
class ListAdsTargets2Request
{
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListAdsTargets2QueryParamFields> $fields
     */
     ...
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListAdsTargets2QueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $orgId
