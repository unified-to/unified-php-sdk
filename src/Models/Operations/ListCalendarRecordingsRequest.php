...
class ListCalendarRecordingsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $connectionId, ?string $endLe = null, ?string $eventId = null, ?array $fields = null, ?float $limit = null, ?float $offset = null, ?string $order = null, ?string $query = null, ?string $sort = null, ?string $startGte = null, ?\DateTime $updatedGte = null)
    {
