...
class ListAccountingBalancesheets2Request
{
    /**
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListAccountingBalancesheets2QueryParamFields> $fields
     */
     ...
     * @param  ?string  $endLt
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListAccountingBalancesheets2QueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $query
