...
class CreateCommerceItemvariantRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Shared\CommerceItemvariant1 $commerceItemvariant, string $connectionId, ?array $fields = null, ?string $raw = null)
    {
