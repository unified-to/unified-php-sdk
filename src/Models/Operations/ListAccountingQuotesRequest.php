...
class ListAccountingQuotesRequest
{
    /**
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListAccountingQuotesQueryParamFields> $fields
     */
     ...
     * @param  ?string  $endLt
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListAccountingQuotesQueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $orgId
     ...
     * @phpstan-pure
     */
    public function __construct(string $connectionId, ?string $contactId = null, ?string $endLt = null, ?array $fields = null, ?float $limit = null, ?float $offset = null, ?string $order = null, ?string $orgId = null, ?string $projectId = null, ?string $query = null, ?string $raw = null, ?string $sort = null, ?string $startGte = null, ?string $status = null, ?string $updatedGte = null)
    {
