...
class ListDatastoreDatabasesRequest
{
    /**
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListDatastoreDatabasesQueryParamFields> $fields
     */
     ...
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListDatastoreDatabasesQueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $query
