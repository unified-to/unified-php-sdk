...
class CreateCrmPipeline2Response
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\CrmPipeline $crmPipeline = null)
    {
