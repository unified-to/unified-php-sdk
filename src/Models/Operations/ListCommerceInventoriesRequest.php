...
class ListCommerceInventoriesRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $connectionId, ?array $fields = null, ?string $itemVariantId = null, ?float $limit = null, ?string $locationId = null, ?float $offset = null, ?string $order = null, ?string $query = null, ?string $raw = null, ?string $sort = null, ?\DateTime $updatedGte = null)
    {
