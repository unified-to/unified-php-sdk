...
class ListCrmEvents2Request
{
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListCrmEvents2QueryParamFields> $fields
     */
     ...
     * @param  ?string  $dealId
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListCrmEvents2QueryParamFields>  $fields
     * @param  ?string  $leadId
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
