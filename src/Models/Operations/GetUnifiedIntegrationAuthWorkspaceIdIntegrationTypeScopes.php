...
enum GetUnifiedIntegrationAuthWorkspaceIdIntegrationTypeScopes: string
{
    ...
    case CrmUserRead = 'crm_user_read';
    case CrmUserWrite = 'crm_user_write';
    ...
    case CrmTeamRead = 'crm_team_read';
    case CrmTeamWrite = 'crm_team_write';
    ...
    case TicketingAgentRead = 'ticketing_agent_read';
    case TicketingAgentWrite = 'ticketing_agent_write';
