...
class ListCrmCompaniesRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $connectionId, ?string $contactId = null, ?string $dealId = null, ?array $fields = null, ?float $limit = null, ?float $offset = null, ?string $order = null, ?string $query = null, ?string $raw = null, ?string $sort = null, ?\DateTime $updatedGte = null, ?string $userId = null)
    {
