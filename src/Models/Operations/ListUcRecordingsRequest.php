...
class ListUcRecordingsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $connectionId, ?string $callId = null, ?string $contactId = null, ?string $endLe = null, ?array $fields = null, ?float $limit = null, ?float $offset = null, ?string $order = null, ?string $query = null, ?string $raw = null, ?string $sort = null, ?string $startGte = null, ?string $updatedGte = null, ?string $userId = null)
    {
