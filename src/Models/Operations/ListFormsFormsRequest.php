...
class ListFormsFormsRequest
{
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListFormsFormsQueryParamFields> $fields
     */
     ...
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListFormsFormsQueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $query
