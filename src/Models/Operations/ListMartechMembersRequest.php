...
class ListMartechMembersRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $connectionId, ?array $fields = null, ?float $limit = null, ?string $listId = null, ?float $offset = null, ?string $order = null, ?string $query = null, ?string $raw = null, ?string $sort = null, ?\DateTime $updatedGte = null)
    {
