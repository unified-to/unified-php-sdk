...
class ListAccountingCashflows2Request
{
    /**
     ...
     * Fields to return
     *
     * @var ?array<\Unified\Unified_to\Models\Operations\ListAccountingCashflows2QueryParamFields> $fields
     */
     ...
     * @param  ?string  $endLt
     * @param  ?array<\Unified\Unified_to\Models\Operations\ListAccountingCashflows2QueryParamFields>  $fields
     * @param  ?float  $limit
     * @param  ?float  $offset
     * @param  ?string  $order
     * @param  ?string  $query
